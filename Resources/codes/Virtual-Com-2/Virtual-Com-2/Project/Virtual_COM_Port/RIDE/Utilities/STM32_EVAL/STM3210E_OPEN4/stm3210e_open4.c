/**
  ...
  *          available on STM3210E-OPEN4 evaluation board from Raisonance.  
  ******************************************************************************
  * @copy
  *
...
/** @defgroup STM3210E_OPEN4_LOW_LEVEL 
  * @{
  */ 

/** @defgroup STM3210E_OPEN4_LOW_LEVEL_Private_TypesDefinitions
  * @{
  */ 
/**
  * @}
...
/** @defgroup STM3210E_OPEN4_LOW_LEVEL_Private_Defines
  * @{
  */ 
/**
  * @}
...
/** @defgroup STM3210E_OPEN4_LOW_LEVEL_Private_Macros
  * @{
  */ 
/**
  * @}
...
/** @defgroup STM3210E_OPEN4_LOW_LEVEL_Private_Variables
  * @{
  */ 
...
USART_TypeDef* COM_USART[COMn] = {OPEN4_COM1}; 

GPIO_TypeDef* COM_TX_PORT[COMn] = {OPEN4_COM1_TX_GPIO_PORT};
 
GPIO_TypeDef* COM_RX_PORT[COMn] = {OPEN4_COM1_RX_GPIO_PORT};
 
const uint32_t COM_USART_CLK[COMn] = {OPEN4_COM1_CLK};

const uint32_t COM_TX_PORT_CLK[COMn] = {OPEN4_COM1_TX_GPIO_CLK};
 
const uint32_t COM_RX_PORT_CLK[COMn] = {OPEN4_COM1_RX_GPIO_CLK};

const uint16_t COM_TX_PIN[COMn] = {OPEN4_COM1_TX_PIN};

const uint16_t COM_RX_PIN[COMn] = {OPEN4_COM1_RX_PIN};
...
/** @defgroup STM3210E_OPEN4_LOW_LEVEL_Private_FunctionPrototypes
  * @{
  */ 
...
/** @defgroup STM3210E_OPEN4_LOW_LEVEL_Private_Functions
  * @{
  */ 
